...
public interface SubmissionLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SubmissionLocalServiceUtil} to access the submission local service. Add custom service methods to <code>com.vasslatam.training.gradebook.service.impl.SubmissionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
