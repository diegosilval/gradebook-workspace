...
public interface AssignmentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssignmentLocalServiceUtil} to access the assignment local service. Add custom service methods to <code>com.vasslatam.training.gradebook.service.impl.AssignmentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
