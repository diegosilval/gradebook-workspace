...
package com.vasslatam.training.gradebook.service.persistence;
...
public class SubmissionUtil {
	...
	public static Submission findByGroupId_First(
		...
		throws com.vasslatam.training.gradebook.exception.
	 ...
	 * @return the matching submissions
	 */
	public static List<Submission> findByS_A(
		long studentId, long assignmentId) {

		return getPersistence().findByS_A(studentId, assignmentId);
	}
	...
	public static List<Submission> findByS_A(
		...
		return getPersistence().findByS_A(studentId, assignmentId, start, end);
	}
	...
	public static List<Submission> findByS_A(
		...
		return getPersistence().findByS_A(
	 ...
	 * @throws NoSuchSubmissionException if a matching submission could not be found
	 */
	public static Submission findByS_A_First(
			long studentId, long assignmentId,
			OrderByComparator<Submission> orderByComparator)
		throws com.vasslatam.training.gradebook.exception.
			NoSuchSubmissionException {

		return getPersistence().findByS_A_First(
	 ...
	 * @return the first matching submission, or <code>null</code> if a matching submission could not be found
	 */
	public static Submission fetchByS_A_First(
		long studentId, long assignmentId,
		OrderByComparator<Submission> orderByComparator) {

		return getPersistence().fetchByS_A_First(
			studentId, assignmentId, orderByComparator);
	}
	 ...
	 * @throws NoSuchSubmissionException if a matching submission could not be found
	 */
	public static Submission findByS_A_Last(
			long studentId, long assignmentId,
			OrderByComparator<Submission> orderByComparator)
		throws com.vasslatam.training.gradebook.exception.
			NoSuchSubmissionException {

		return getPersistence().findByS_A_Last(
			studentId, assignmentId, orderByComparator);
	}
	 ...
	 * @return the last matching submission, or <code>null</code> if a matching submission could not be found
	 */
	public static Submission fetchByS_A_Last(
		long studentId, long assignmentId,
		OrderByComparator<Submission> orderByComparator) {

		return getPersistence().fetchByS_A_Last(
			studentId, assignmentId, orderByComparator);
	}
	 ...
	 * @throws NoSuchSubmissionException if a submission with the primary key could not be found
	 */
	public static Submission[] findByS_A_PrevAndNext(
			long submissionId, long studentId, long assignmentId,
			OrderByComparator<Submission> orderByComparator)
		throws com.vasslatam.training.gradebook.exception.
			NoSuchSubmissionException {

		return getPersistence().findByS_A_PrevAndNext(
	 ...
	 * @param assignmentId the assignment ID
	 */
	public static void removeByS_A(long studentId, long assignmentId) {
		getPersistence().removeByS_A(studentId, assignmentId);
	}
	 ...
	 * @return the number of matching submissions
	 */
	public static int countByS_A(long studentId, long assignmentId) {
		return getPersistence().countByS_A(studentId, assignmentId);
	}
