...
import com.vasslatam.training.gradebook.service.base.SubmissionServiceBaseImpl;

/**
 * The implementation of the submission remote service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.vasslatam.training.gradebook.service.SubmissionService</code> interface.
 *
 * <p>
...
public class SubmissionServiceImpl extends SubmissionServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use <code>com.vasslatam.training.gradebook.service.SubmissionServiceUtil</code> to access the submission remote service.
	 */
