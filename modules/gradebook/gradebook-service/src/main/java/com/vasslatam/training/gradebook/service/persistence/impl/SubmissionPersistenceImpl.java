...
package com.vasslatam.training.gradebook.service.persistence.impl;
...
import com.vasslatam.training.gradebook.exception.NoSuchSubmissionException;
import com.vasslatam.training.gradebook.model.Submission;
import com.vasslatam.training.gradebook.model.impl.SubmissionImpl;
import com.vasslatam.training.gradebook.model.impl.SubmissionModelImpl;
import com.vasslatam.training.gradebook.service.persistence.SubmissionPersistence;
import com.vasslatam.training.gradebook.service.persistence.impl.constants.gradebookPersistenceConstants;
...
public class SubmissionPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByS_A;
	private FinderPath _finderPathWithoutPaginationFindByS_A;
	private FinderPath _finderPathCountByS_A;
	 ...
	 */
	@Override
	public List<Submission> findByS_A(long studentId, long assignmentId) {
		return findByS_A(
	 ...
	 */
	@Override
	public List<Submission> findByS_A(
		long studentId, long assignmentId, int start, int end) {

		return findByS_A(studentId, assignmentId, start, end, null);
	}
	...
	public List<Submission> findByS_A(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByS_A;
				finderArgs = new Object[] {studentId, assignmentId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByS_A;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_S_A_STUDENTID_2);

			query.append(_FINDER_COLUMN_S_A_ASSIGNMENTID_2);
	 ...
	 */
	@Override
	public Submission findByS_A_First(
			long studentId, long assignmentId,
			OrderByComparator<Submission> orderByComparator)
		throws NoSuchSubmissionException {

		Submission submission = fetchByS_A_First(
	 ...
	 */
	@Override
	public Submission fetchByS_A_First(
		long studentId, long assignmentId,
		OrderByComparator<Submission> orderByComparator) {

		List<Submission> list = findByS_A(
	 ...
	 */
	@Override
	public Submission findByS_A_Last(
			long studentId, long assignmentId,
			OrderByComparator<Submission> orderByComparator)
		throws NoSuchSubmissionException {

		Submission submission = fetchByS_A_Last(
			studentId, assignmentId, orderByComparator);
	 ...
	 */
	@Override
	public Submission fetchByS_A_Last(
		long studentId, long assignmentId,
		OrderByComparator<Submission> orderByComparator) {

		int count = countByS_A(studentId, assignmentId);
	 ...
	 */
	@Override
	public Submission[] findByS_A_PrevAndNext(
	...
	protected Submission getByS_A_PrevAndNext(
		Session session, Submission submission, long studentId,
	 ...
	 */
	@Override
	public void removeByS_A(long studentId, long assignmentId) {
		for (Submission submission :
				findByS_A(
	 ...
	 */
	@Override
	public int countByS_A(long studentId, long assignmentId) {
		FinderPath finderPath = _finderPathCountByS_A;
	...
	private static final String _FINDER_COLUMN_S_A_STUDENTID_2 =
		"submission.studentId = ? AND ";

	private static final String _FINDER_COLUMN_S_A_ASSIGNMENTID_2 =
		"submission.assignmentId = ?";
	...
	public Submission updateImpl(Submission submission) {
		...
		if (!_columnBitmaskEnabled) {
			...
			finderCache.removeResult(_finderPathCountByS_A, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByS_A, args);
			...
			if ((submissionModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByS_A.getColumnBitmask()) !=
					 0) {
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByS_A = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, SubmissionImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByS_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByS_A = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, SubmissionImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByS_A",
			new String[] {Long.class.getName(), Long.class.getName()},
			SubmissionModelImpl.STUDENTID_COLUMN_BITMASK |
			SubmissionModelImpl.ASSIGNMENTID_COLUMN_BITMASK);

		_finderPathCountByS_A = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByS_A",
			new String[] {Long.class.getName(), Long.class.getName()});
	}
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.vasslatam.training.gradebook.model.Submission"),
			true);
	}
